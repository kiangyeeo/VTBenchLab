...
OUT_ROOT="${OUT_ROOT:-$WORKSPACE/outputs/vae_linear_probing_dinov2_single_paperlr_bn}"
NUM_WORKERS="${NUM_WORKERS:-8}"

run_tokenizer_linear_probe_bn() {
    local model="$1"
    shift
    ...
    echo "   frozen-backbone feature microbatch=${FEATURE_MICROBATCH_SIZE:-1024}; concatenated before BN"
