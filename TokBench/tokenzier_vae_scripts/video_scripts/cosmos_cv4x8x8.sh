#!/bin/bash
# Reconstruction with the continuous Cosmos tokenizer CosmosCV4x8x8.
# Usage:
#   CUDA_VISIBLE_DEVICES=0 SHORT_SIZES="256" bash cosmos_cv4x8x8.sh
set -e
...
MODEL_DIR="$MODEL_ROOT/Cosmos-0.1-Tokenizer-CV4x8x8"
