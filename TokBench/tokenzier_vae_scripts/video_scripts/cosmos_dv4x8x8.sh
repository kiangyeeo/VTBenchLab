#!/bin/bash
# Reconstruction with CosmosDV4x8x8.
# Usage:
#   CUDA_VISIBLE_DEVICES=0 SHORT_SIZES="256" bash cosmos_dv4x8x8.sh
set -e
...
MODEL_DIR="$MODEL_ROOT/Cosmos-0.1-Tokenizer-DV4x8x8"
