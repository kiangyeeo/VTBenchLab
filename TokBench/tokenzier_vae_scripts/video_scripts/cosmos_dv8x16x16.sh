#!/bin/bash
# Reconstruction with CosmosDV8x16x16.
# Usage:
#   CUDA_VISIBLE_DEVICES=0 SHORT_SIZES="256" bash cosmos_dv8x16x16.sh
set -e
...
MODEL_DIR="$MODEL_ROOT/Cosmos-0.1-Tokenizer-DV8x16x16"
