#!/bin/bash
# Reconstruction with the Stable Diffusion 3.5 Large VAE.
# Usage:
#   CUDA_VISIBLE_DEVICES=0 PADDING_SIZES="256" bash sd3p5.sh
set -e
...
MODEL_NAME="${MODEL_NAME:-sd3p5}"
MODEL_PATH="${MODEL_PATH:-$MODEL_ZOO/sd3p5-large-vae/vae}"
...
if [ ! -d "$MODEL_PATH" ]; then
    echo "Missing SD-3.5 VAE directory: $MODEL_PATH"
