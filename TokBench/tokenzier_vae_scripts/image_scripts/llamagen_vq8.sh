#!/bin/bash
# Reconstruction with the LlamaGen VQ-8 image tokenizer.
# Usage:
#   CUDA_VISIBLE_DEVICES=0 PADDING_SIZES="256" bash llamagen_vq8.sh
set -e
...
MODEL_NAME="${MODEL_NAME:-llamagen_vq8}"
LLAMAGEN_PATH="${LLAMAGEN_PATH:-$SCRIPT_DIR/LlamaGen}"
CKPT_PATH="${CKPT_PATH:-$MODEL_ZOO/LlamaGen/vq_ds8_c2i.pt}"
