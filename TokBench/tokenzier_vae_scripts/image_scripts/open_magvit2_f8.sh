#!/bin/bash
# Reconstruction with Open-MAGVIT2 ImageNet f8.
# Usage:
#   CUDA_VISIBLE_DEVICES=0 PADDING_SIZES="256" bash open_magvit2_f8.sh
set -e
...
MODEL_NAME="${MODEL_NAME:-magvit2_imgnet_f8}"
SEED_VOKEN_PATH="${SEED_VOKEN_PATH:-$SCRIPT_DIR/SEED-Voken}"
CKPT_PATH="${CKPT_PATH:-$MODEL_ZOO/Open_MAGVIT2/imagenet_128_L/imagenet_128_L.ckpt}"
